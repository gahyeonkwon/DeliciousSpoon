    ...
    if(action.equals("go")) {
        ...
        String user_id = base64Encode("zkvmflcldh0"); // SMS아이디
        String secure = base64Encode("인증후 사용하세요");//인증키
       ...
       swal('전송완료','문자가 성공적으로 전송되었습니다','success')
      .then((value) => {
          location.href = 'store_condition.jsp';
         });
